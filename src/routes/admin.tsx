...
import { LayoutDashboard, Package, ShoppingBag, Users, Settings as SettingsIcon, Coins, BadgeDollarSign, CreditCard, Tags, MessageCircle, LifeBuoy, Truck } from "lucide-react";
